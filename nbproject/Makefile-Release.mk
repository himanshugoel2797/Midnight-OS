...
${OBJECTDIR}/Core/APIC.o: Core/APIC.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/APIC.o Core/APIC.cpp

${OBJECTDIR}/Core/BIOSMemoryMap.o: Core/BIOSMemoryMap.cpp 
	${MKDIR} -p ${OBJECTDIR}/Core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/BIOSMemoryMap.o Core/BIOSMemoryMap.cpp

${OBJECTDIR}/Core/Tables/CPUID.o: Core/Tables/CPUID.cpp 
	${MKDIR} -p ${OBJECTDIR}/Core/Tables
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/Tables/CPUID.o Core/Tables/CPUID.cpp

${OBJECTDIR}/Core/Tables/InterruptHandlers.o: Core/Tables/InterruptHandlers.cpp 
	${MKDIR} -p ${OBJECTDIR}/Core/Tables
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/Tables/InterruptHandlers.o Core/Tables/InterruptHandlers.cpp

${OBJECTDIR}/Core/Tables/Tables.o: Core/Tables/Tables.cpp 
	${MKDIR} -p ${OBJECTDIR}/Core/Tables
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Core/Tables/Tables.o Core/Tables/Tables.cpp

${OBJECTDIR}/DisplayText.o: DisplayText.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DisplayText.o DisplayText.cpp

${OBJECTDIR}/HAL/HAL_PIC.o: HAL/HAL_PIC.cpp 
	${MKDIR} -p ${OBJECTDIR}/HAL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HAL/HAL_PIC.o HAL/HAL_PIC.cpp

${OBJECTDIR}/HAL/I686_Core.o: HAL/I686_Core.cpp 
	${MKDIR} -p ${OBJECTDIR}/HAL
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HAL/I686_Core.o HAL/I686_Core.cpp
...
${OBJECTDIR}/crt0.o: crt0.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/crt0.o crt0.cpp

${OBJECTDIR}/crti.o: crti.s 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/crti.o crti.s

${OBJECTDIR}/crtn.o: crtn.s 
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/crtn.o crtn.s
